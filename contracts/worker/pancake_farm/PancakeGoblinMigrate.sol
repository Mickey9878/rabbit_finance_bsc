...
contract PancakeswapGoblinMigrate is Governable,ReentrancyGuardUpgradeSafe, Goblin {
    /// @notice Libraries
    ...
    event MigrateMasterChefV2(address indexed masterChef, uint256 pid, address masterChefV2, uint256 newPid);
    ...
    // TODO During redeployment, change the value to IMasterChefV2
    function initialize(
        address _operator,
    ...
    function shareToBalance(uint share) public view returns (uint) {
        ...
        (uint totalBalance, , ) = masterChefV2.userInfo(pid, address(this));
    ...
    function migrateLP(IMasterChefV2 _masterChefV2, uint256 _newPid) external {
        ...
        lpToken.approve(address(_masterChefV2), uint(-1));
        ...
        emit MigrateMasterChefV2(address(masterChef), _oldPid, address(_masterChefV2), _newPid);
    }
